    ...
    <AdminLayout>
      <div className="bg-slate-50 min-h-screen">
        <div className="p-4 md:p-8 max-w-[1600px] mx-auto space-y-6">
          ...
          {/* ACTION BAR */}
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 shadow-sm">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <div className="relative flex-1 md:w-72">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none text-sm font-medium"
                  onChange={(e) => setSearchTerm(e.target.value.toLowerCase())}
                />
              </div>
              <button className="flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-100 transition-all">
                <Download size={16} />
          ...
          {/* SPREADSHEET TABLE */}
          <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/50 border-b border-slate-100 dark:border-slate-800 dark:border-slate-800 text-[11px] font-black uppercase tracking-[0.15em] text-slate-400">
                  ...
                  {filteredStudents.map(({ student }) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-4">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-white dark:bg-slate-900 border-2 border-slate-100 text-slate-400 rounded-2xl flex items-center justify-center font-black text-xs group-hover:border-emerald-200 group-hover:text-emerald-600 transition-all">
                      ...
                      <td className="px-8 py-4 text-right">
                        <button className="p-2 text-slate-300 group-hover:text-emerald-600 bg-transparent dark:bg-transparent group-hover:bg-slate-100 dark:group-hover:bg-slate-800 group-hover:shadow-sm rounded-xl transition-all">
